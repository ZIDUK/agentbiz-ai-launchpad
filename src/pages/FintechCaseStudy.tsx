...
import { getFintechCaseStudy } from "@/i18n/content/case-studies";
      ...
      <main className="pt-28 lg:pt-32 pb-20">
        <article className="container max-w-3xl">
          ...
          <p className="text-sm font-semibold tracking-wider text-primary mb-3 uppercase">
            {t("caseStudy.label")} · FinTech · {content.readTime}
          </p>
            ...
            <section className="card-hover p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button asChild className="btn-primary">
                  <Link to="/industries/fintech">{t("caseStudy.fintechIndustry")}</Link>
                </Button>
