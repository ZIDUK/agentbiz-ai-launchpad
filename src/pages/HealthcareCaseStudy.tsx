...
import { getHealthcareCaseStudy } from "@/i18n/content/case-studies";
      ...
      <main className="pt-28 lg:pt-32 pb-20">
        <article className="container max-w-3xl">
          ...
          <p className="text-sm font-semibold tracking-wider text-primary mb-3 uppercase">
            {t("caseStudy.healthcareLabel")} · {content.readTime}
          </p>
          ...
          <div className="prose max-w-none space-y-10">
            ...
            <section>
              ...
              <p className="text-xs text-muted-foreground">{t("caseStudy.metricsDisclaimerHealthcare")}</p>
            </section>
            ...
            <section className="card-hover p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button asChild className="btn-primary">
                  <Link to="/industries/healthcare">{t("caseStudy.healthcareIndustry")}</Link>
                </Button>
